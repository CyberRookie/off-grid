                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-lg-6 col-md-12 col-xl-6">
                                    ...
                                    <?php if (isset($Response['full_name']) && !empty($Response['full_name'])): ?>
                                        <small class="alert alert-danger alert-dismissable"><?php echo $Response['full_name']; ?></small>
                                    <?php endif; ?>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-lg-6 col-md-12 col-xl-6">
                                    <div class="form-group">
                                    ...
                                    <?php if (isset($Response['username']) && !empty($Response['username'])): ?>
                                        <small class="alert alert-danger alert-dismissable"><?php echo $Response['username']; ?></small>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="row">
